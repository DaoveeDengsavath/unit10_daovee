...
class _HomeState extends State<Home> {
  ...
  Image _buildJournalHeaderImage() {
    return Image(
      image: AssetImage('assets/img/boxx.jpg'),
      fit: BoxFit.cover,
    );
  }
  ...
  Row _buildJournalFooterImages() {
    return Row(
      ...
      children: <Widget>[
        CircleAvatar(
          backgroundImage: AssetImage('assets/img/aa.jpeg'),
          radius: 40.0,
        ),
        CircleAvatar(
          backgroundImage: AssetImage('assets/img/dd.jpeg'),
          radius: 40.0,
        ),
        CircleAvatar(
          backgroundImage: AssetImage('assets/img/hh.jpg'),
          radius: 40.0,
        ),
        SizedBox(
          width: 100.0,
